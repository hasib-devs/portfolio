...
const Resume = () => {
    return (
        <div>
            ...
            <div className="p-10">
                <div className="resume-container text-sm">
                    {/* <!-- Print container --> */}
                    <div>
                        {/* <!-- Header --> */}
                        ...
                        <div className="md:flex md:items-center">
                            ...
                            <p className="md:w-4/5 pl-4 mt-4 md:mt-0">
                                ...
                                since 2017. I can design and develop any type of
                                website, web-based application using front-end
                                Vue JS with Node JS or Laravel Backend.
                                <br />
                                Starting out at the age of 17 I never stopped
                                learning new programming skills and languages.
                                Early I started creating websites for curiosity
                                and just for fun as well. And then I became a
                                good web designer with HTML, CSS, and jQuery
                                (jQuery was a hero!). Besides Front-end
                                development, I also explored Backend and other
                                non-web-only technologies. This passion has
                                since lasted and led to my decision to work as a
                                freelance web developer. The success and fun I
                                have in this job are immense and really keep
                        ...
                        <div className="lg:flex mt-10">
                            ...
                            <div className="lg:w-9/12">
                                ...
                                <p>
                                    I have been working with Jara It for more
                                    than six months. This is my first-time
                                    working experience remotely. They are very
                                    helpful and cool guys. Primarily they use
                                    Laravel for their backend and Vue JS and
                                    React JS for the front-end development.
                                </p>
                                <p>
                                    Some of the project I'have done with this
                                    team.
                                </p>
                                ...
                                <p>
                                    I have been working with 999 It Solutions
                                    for more than two year. And I learned lots
                                    of things from them. Some of them are, how
                                    to work professionally, team management, and
                                    better coding structure. Primarily they uses
                                    Laravel for their backend and Vue JS for the
                                ...
                                <p></p>
                                <p>
                                    This is a very small team where I worked as
                                    a front-end developer. That was my first
                                    real-life working experience. They make
                                    templates for WordPress and some other CMS
                                    management systems.
                                </p>
                                <p>
                                    Some of the project I'have done with this
                                ...
                                <p>
                                    ...
                                    Our team uses Laravel API for backend and
                                    Nuxt JS to manage front-end. This is the
                                    most complecated project I'have ever done. I
                                    enjoyed and learnd lots of thinks from this
                                    project.
                                </p>
                                ...
                                <p>
                                    ...
                                    where a buyer can post their job offer and
                                    user can apply for the job. Our team uses
                                    Laravel API for backend and Nuxt JS to
                                    manage front-end. Here I learned how a
                                    marketplace actually works and manage
                                ...
                                <p>
                                    ...
                                    Laravel jetstream for backend admin panel
                                    Nuxt JS to manage front-end.
                                </p>
                            </div>
